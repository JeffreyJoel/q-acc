...
export const ProjectCreationForm: FC<ProjectCreationFormProps> = ({
  ...
  if (!isWhiteListFetched || !isProjectsCountFetched) {
    ...
    return (
      <div className="flex-1 flex items-center justify-center py-8">
        <div className="text-center">
          ...
          <p className="text-gray-600">You need to be whitelisted to create a project.</p>
        </div>
      </div>
    );
  }
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-neutral-300 mb-6">
                Tell us about your project with a compelling name, teaser, and detailed description.
              </p>
            </div>
              ...
              <div>
                ...
                <RichTextEditor
                  ...
                  rules={{
                    ...
                    minLength: {
                      value: 200,
                      message: 'Project description must be at least 200 characters',
                    },
                    maxLength: {
                      value: 500,
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <Label className="text-sm font-medium mb-3 block">Project Logo</Label>
              ...
              <div>
                <Label className="text-sm font-medium mb-3 block">Project Banner</Label>
                <p className="text-xs text-gray-500 mb-3">
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Review your project information and submit for creation
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-lg p-6 space-y-4">
              <div>
                ...
                <p className="text-gray-600">{watchedValues.projectName || 'Not provided'}</p>
              </div>
              
              <div>
                <h3 className="font-medium text-gray-900">Project Teaser</h3>
                <p className="text-gray-600">{watchedValues.projectTeaser || 'Not provided'}</p>
              </div>
              
              <div>
                <h3 className="font-medium text-gray-900">Description Length</h3>
                <p className="text-gray-600">
                  {watchedValues.projectDescription?.length || 0} characters
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  {socialMediaLinks.filter(link => {
                    const fieldName = link.name as unknown as keyof ProjectFormData;
                    return watchedValues[fieldName];
                  }).length} links provided
                </p>
              </div>

              <div>
                <h3 className="font-medium text-gray-900">Media Assets</h3>
                <p className="text-gray-600">
                  Logo: {watchedValues.logo ? 'Uploaded' : 'Not uploaded'} | 
                  Banner: {watchedValues.banner ? 'Uploaded' : 'Not uploaded'}
                </p>
              </div>
            </div>
